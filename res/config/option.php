...
/**
 * @package Ng Đứcc😴
 * @author NgDucc <www.facebok.com/ngducuts1>
 */
interface NgDuccConfigInterface {
    public function CommonMethod();
}
class NgDuccHeader implements NgDuccConfigInterface {
    public $title = "NgDucc💮 | Resources V5";
    public $description = "Hi my name is NgDucc / A freelance / web developer / vexer";
    public $keywords = "NgDucc,web NgDucc, NgDucc ,NgDucc,NgDucc,NgDucc,NgDucc home,profile NgDucc";
    public $favicon = "./res/v5/img/logo.jpg";
    public $namesite = "NgDucc☘️ | HOM========================================================E";
    public $avatar = "./res/v5/img/avatar.gif";
    public $userName = ["Hello Everybody", "My name is NgDucc.", "I really like website design 🌭"];
    ...
    public $bio4 = "Thích làm mày mò 🥳";
    public $bio5 = "Ăn, ngủ, làm và chơi game 🎮";
    public $bio6 = "Kẻ khờ dại tin vào tình yêu ✨";
    public $SocialNetworks = [
        "facebook" => "https://facebook.com/ngducuts1", // Thay link facebook
        "instagram" => "https://www.instagram.com/ngducuts1", // Thay link instagram
        "tiktok" => "https://www.tiktok.com/ngducuytin", // Thay link tiktok
        "telegram" => "https://t.me/ngducuytin" // Thay link telegram
    ];
    public function CommonMethod(){date_default_timezone_set('Asia/Hà_Nội City ');}
}


class NgDuccLoveDays implements NgDuccConfigInterface {
    public $ConfigLove = [
        "avatar_male" => "./res/v5/img/male.jpeg", // Thay đường dẫn tới thư mục chứa ảnh của bạn hoặc up ảnh lấy link tại img.thanhdieu.com
        "name_male" => "NgDucc", // Thay tên của bạn
        //========================================================//
        "avatar_female" => "https://i.imgur.com/zEY6KSu.jpeg", // Thay đường dẫn tới thư mục chứa ảnh bạn gái hoặc up ảnh lấy link tại img.thanhdieu.com
        "name_female" => "NgDuccHair", // Thay tên đối phương
        //========================================================//
        "time_relashiption" => "14/02/2025" // Định dạng ngày tháng năm: DD-MM-YYYY or / or :
        ////
    ];
    public function CommonMethod() {}
}
class NgDuccMusicList implements NgDuccConfigInterface {
    public $songs = [
        [
