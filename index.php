...
<?php 
$NgDuccHeader = new NgDuccHeader();
$NgDuccLoveDays = new NgDuccLoveDays();
$NgDuccMusicList = new NgDuccMusicList();
$NgDuccHeader->CommonMethod();
$NgDuccLoveDays->CommonMethod();
$NgDuccMusicList->CommonMethod();
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta name="description" content="<?=$NgDuccHeader->description?>">
    <meta name="author" content="NgDucc💮🌸">
    <meta name="keywords"
        content="<?=$NgDuccHeader->keywords?>">
    <meta name="robots" content="index, follow">
    <meta property="og:type" content="website">
    <link rel="shortcut icon" href="<?=$NgDuccHeader->favicon?>?v=<?=rand(1,999)?>" type="image/x-icon">
    <meta property="og:title" content="<?=$NgDuccHeader->title?>">
    <meta property="og:url" content="//NgDucc.com">
    <meta property="og:image" content="./res/v5/img/bg3.webp">
    <title><?=$NgDuccHeader->title?></title>
    <!--/ @StyleSheets /-->
...
<body class="BodyStyle">
        ...
        <section class="td-welcome">
            ...
            <div class="infos">
                <div class="logo-web-title">
                    <img class="logo-ws" src="https://i.imgur.com/KOTqJvD.gif" alt="NgDucc">
    ...
    <div id="loading-box">
        <div class="loading-bg">
            <img class="loading-img entered loading" src="<?=$NgDuccHeader->favicon?>?v=<?=rand(1,999)?>" data-ws-status="loading">
    ...
    <main id="td-main">
            ...
            <div class="td-popup" id="share_card">
                <div class="left">
                    ...
                    <div class="button mt-2">
                        ...
                        <span class="td-btn"
                            onclick="window.open('https://www.messenger.com/t/' + encodeURIComponent('ngducuts1'),'top');"
        ...
        <section class="td-content">
            <div class="about-me">
                <div class="info-left">
                    <span class="tag"><?=$NgDuccHeader->bio1?></span>
                    <span class="tag"><?=$NgDuccHeader->bio2?></span>
                    <span class="tag"><?=$NgDuccHeader->bio3?></span>
                </div>
                <div class="avatar">
                    <img class="avatar-img" src="<?=$NgDuccHeader->avatar?>?v=<?=rand(1,999)?>" alt="NgDucc">
                    <img class="crown" src="./res/v5/img/crown/mong-vuot-rong.png">
                    <!-- <img class="crown2" src="./res/v5/img/crown/vip-crown.png"> -->
                </div>
                <div class="info-right">
                    <span class="tag"><?=$NgDuccHeader->bio4?></span>
                    <span class="tag"><?=$NgDuccHeader->bio5?></span>
                    <span class="tag"><?=$NgDuccHeader->bio6?></span>
                </div>
            </div>
            <div class="padding" style="height:2em;"></div>
            <h2 class="Dev NgDucc__">
                <span id="userName" data-userName='<?= json_encode($NgDuccHeader->userName ?? []) ?>'></span>
            </h2>
            <div class="about-me-2">
                <button class="trigger"><?=$NgDuccHeader->trigger?></button>
                <button class="trigger"><?=$NgDuccHeader->bio1?></button>
                <button class="trigger"><?=$NgDuccHeader->bio2?></button>
                <button class="trigger"><?=$NgDuccHeader->bio3?></button>
                <button class="trigger"><?=$NgDuccHeader->bio4?></button>
                <button class="trigger"><?=$NgDuccHeader->bio5?></button>
                <button class="trigger"><?=$NgDuccHeader->bio6?></button>
            </div>
            <div class="padding" style="height:1em;"></div>
            <section id="hr-mod">
                <?php foreach ($NgDuccHeader->SocialNetworks as $network => $url): ?>
    ...
    <div class="padding" style="height:4em;"></div>
        <div class="love-time1 mt-5">
            <div class="hide" data-ngayyeu="<?= $NgDuccLoveDays->ConfigLove['time_relashiption']; ?>"></div>
        ...
        <div class="bg-wrap central mt-5">
            <div class="bg-img">
                <div class="middle animated">
                    <div class="img-male">
                        <img src="<?=$NgDuccLoveDays->ConfigLove['avatar_male'];?>"
                            alt="<?=$NgDuccLoveDays->ConfigLove['name_male'];?>">
                        <img class="crown-love" src="./res/v5/img/crown/khung-4.png">
                        <span><?=$NgDuccLoveDays->ConfigLove['name_male'];?></span>
                    </div>
                    <div class="heart"></div>
                    <div class="img-female">
                        <img src="<?=$NgDuccLoveDays->ConfigLove['avatar_female'];?>"
                            alt="<?=$NgDuccLoveDays->ConfigLove['name_female'];?>">
                        <img class="crown-love" src="./res/v5/img/crown/khung-4.png">
                        <span><?=$NgDuccLoveDays->ConfigLove['name_female'];?></span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="nk-opt-set">
                                ...
                                <div class="nk-opt-list">
                                    <ul class="music_menu_list">
                                        <?php foreach ($NgDuccMusicList->songs as $song): ?>
                                        <li url="<?= $song['url'] ?>">
                                            <span class="name">
    ...
    <footer id="footer">
        <span>
            <a href="//NgDucc.com" target="_blank">&copy; Copyright&nbsp;NgDucc 💮 2025</a>
        </span>
    </footer>
    ...
    <script src="//cdn.NgDucc.com/dialog/wstoast/ws.toast.js"></script>
